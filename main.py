...
with st.sidebar:
    ...
    ironconcentrate = st.slider(
        ...
        min_value=61.00,
        max_value=69.00,
        Value=65.41,#Valor Inicial
        step=0.001, 
    )
    st.caption("Representa el porcentaje de concentración de hierro.")

    # Slider para la Flotation Column 03 Air Flow
...
if model is not None:
    ...
    if st.button('🚀 Predecir el porcentaje de silica', type="primary"):
        ...
        # ['Amina Flow', 'Flotation Column 03 Air Flow', '% Iron Concentrate']
...
with st.expander("ℹ Sobre la Aplicación"):
    ...
    * *Propósito:* Predecir el valor continuo del Porcentaje de Silica.
    * *Características Usadas:* Porcentaje de concentración de hierro, Flujo de amina y Flujo de aire en la columna de flotación.
    """)
